...
{
    // Call into TxToUniv() in zerohour-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in zerohour-common, so we query them here and push the
                            ...
                            {"contract", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                {
                                    ...
                                    {"amount", RPCArg::Type::AMOUNT,  /* default */ "0", "Value in ZHC to send with the call, should be a valid amount, default 0"},
...
static UniValue decoderawtransaction(const JSONRPCRequest& request)
{
    const RPCHelpMan help{"decoderawtransaction",
            ...
            "         \"type\" : \"pubkeyhash\",  (string) The type, eg 'pubkeyhash'\n"
            "         \"addresses\" : [           (json array of string)\n"
            "           \"Q2tvKAXCxZjSmdNbao16dKXC8tRWfcF5oc\"   (string) zerohour address\n"
            "           ,...\n"
            "         ]\n"
            "       }\n"
            "     }\n"
