...
#include "genesis/zerohourMainNetwork.cpp"
...
#include "genesis/test/zerohourTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::zerohourMainNetwork: return c_genesisInfoZHCASHMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::zerohourTestNetwork: return c_genesisInfoZHCASHTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::zerohourMainNetwork: return c_genesisStateRootZHCASHMainNetwork;
    case Network::zerohourTestNetwork: return c_genesisStateRootZHCASHTestNetwork;
