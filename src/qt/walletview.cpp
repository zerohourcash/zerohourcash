    ...
    platformStyle(_platformStyle)
{
    ...
    ZRCTokenPage = new ZRCToken(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    ZRCTokenPage->setClientModel(_clientModel);
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    ZRCTokenPage->setModel(_walletModel);
...
{
    setCurrentWidget(ZRCTokenPage);
    ZRCTokenPage->on_goToSendTokenPage();
}

void WalletView::gotoReceiveTokenPage()
{
    setCurrentWidget(ZRCTokenPage);
    ZRCTokenPage->on_goToReceiveTokenPage();
}

void WalletView::gotoAddTokenPage()
{
    setCurrentWidget(ZRCTokenPage);
    ZRCTokenPage->on_goToAddTokenPage();
}
