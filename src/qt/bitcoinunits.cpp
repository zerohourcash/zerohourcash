...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ZHC");
    case mBTC: return QString("mZHC");
    case uBTC: return QString::fromUtf8("μZHC (bits)");
    case SAT: return QString("Zeroshi (sat)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ZHCASHs");
    case mBTC: return QString("Milli-ZHCASHs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-ZHCASHs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
