...
BOOST_AUTO_TEST_CASE(checking_btcecrecover_after_fork){
    ...
    std::vector<ZHCASHTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createZHCASHTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++HASHTX, proxy));
    txBtcEcrecover.push_back(createZHCASHTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++HASHTX, proxy));
    txBtcEcrecover.push_back(createZHCASHTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++HASHTX, proxy));
    txBtcEcrecover.push_back(createZHCASHTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++HASHTX, proxy));
