...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " zerohour-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  zerohour-tx [options] <hex-tx> [commands]  Update hex-encoded zerohour transaction\n" +
            "or:     zerohour-tx [options] -create [commands]   Create hex-encoded zerohour transaction\n" +
            "\n";
