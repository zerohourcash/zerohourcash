...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // zerohour
        hashUTXORoot.SetNull(); // zerohour
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //zerohour
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //zerohour
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //zerohour
    {
